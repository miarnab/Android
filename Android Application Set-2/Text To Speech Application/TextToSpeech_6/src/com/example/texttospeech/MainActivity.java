...
public class MainActivity extends Activity {  
   ...
   public void speakText(View view){
	   ...
	   ttobj.speak(toSpeak1, TextToSpeech.QUEUE_FLUSH, null);
		   ...
		   String toSpeak10=" O Hello, Android is an advanced operating system developed upon the Linux kernel , marketed and owned by Google.Android runs on mobiles , tablets , TVs , wearables and cars .Andy Rubin is the father and creator of the Android operating system.";
		   Toast.makeText(getApplicationContext(), toSpeak10,Toast.LENGTH_LONG).show();       
		   ttobj.speak(toSpeak10, TextToSpeech.QUEUE_FLUSH, null);
	   }
	   else{
		   String toSpeak11=" O Hello!I am an android application named Hello created by Arnab Mitra, built on eclipse IDE and my support extends from android 4.0 (API 14) to android 4.4 (API 19).You must be one of the acquiantances of Arnab Mitra.Sorry your name "+write.getText().toString()+" is not listed for any voice outputs";
