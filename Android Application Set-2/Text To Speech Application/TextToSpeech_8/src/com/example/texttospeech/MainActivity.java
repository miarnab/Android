...
public class MainActivity extends Activity {  
   ...
   public void speakText(View view){
	   ...
	   //Questions that can be asked
		   ...
		   String toSpeak1_2="I can do many things for you I can tell your info if you write your name in the text field also if you write an element I can provide the details of the element";
		   Toast.makeText(getApplicationContext(), toSpeak1_2,Toast.LENGTH_LONG).show();       
		   ttobj.speak(toSpeak1_2, TextToSpeech.QUEUE_FLUSH, null);
	   }
	   ...
	   //Elements of Periodic Table
		   ...
		   String toSpeak16="O Hello you must be one of the acquaintances of Arnab Mitra.Sorry your name "+write.getText().toString()+" is not listed for any voice outputs or this information is not available in the database right now.";
